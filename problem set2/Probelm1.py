# -*- coding: utf-8 -*-
"""
Created on Sun May 13 01:46:41 2018
...
for i in range(12):
    ...
    MinMonthPay = UpdatedBalanceEachMonth*monthlyPaymentRate
    MonthlyUnpaidBalance = UpdatedBalanceEachMonth - MinMonthPay
    UpdatedBalanceEachMonth = MonthlyUnpaidBalance + MonIntRate*MonthlyUnpaidBalance
    #print(UpdatedBalanceEachMonth)
